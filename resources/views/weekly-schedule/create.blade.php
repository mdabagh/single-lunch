...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create Weekly Schedule') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('weekly-schedule.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="is_active" type="checkbox" class="form-control @error('is_active') is-invalid @enderror" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }}>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('weekly-schedule.index') }}" class="btn btn-secondary">
                                    {{ __('Cancel') }}
                                </a>
                            </div>
                        </div>
